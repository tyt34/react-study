...
export const mockStarshipsValue = {
  count: 36,
...
export const mockStarshipValue = {
  name: 'CR90 corvette',
  model: 'CR90 corvette',
  manufacturer: 'Corellian Engineering Corporation',
  cost_in_credits: '3500000',
